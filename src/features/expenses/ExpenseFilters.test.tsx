...
describe('ExpenseFilters - Quinzena & Período (Critério 001)', () => {
  ...
  it('permite selecionar a 1ª Quinzena definindo período de 01/09/2026 a 15/09/2026', () => {
    ...
    expect(props.onEndDateChange).toHaveBeenCalledWith('2026-09-15');
  });

  it('permite selecionar a 2ª Quinzena definindo período de 16/09/2026 a 30/09/2026', () => {
    const props = { ...defaultProps, onStartDateChange: vi.fn(), onEndDateChange: vi.fn(), onPeriodPresetChange: vi.fn() };
    render(<ExpenseFilters {...props} />);
    ...
    expect(props.onStartDateChange).toHaveBeenCalledWith('2026-09-16');
  ...
  it('filtra corretamente gastos da 1ª quinzena vs 2ª quinzena (Critério 001)', () => {
    const mockGastos = [
      ...
      { id: '3', descricao: 'Energia', valor: 250, dataVencimento: '2026-09-20', competencia: '2026-09-01' },
      { id: '4', descricao: 'Cartão de Crédito', valor: 800, dataVencimento: '2026-09-28', competencia: '2026-09-01' },
    ];
    ...
    const gastosPrimeiraQuinzena = mockGastos.filter((g) => {
      ...
      return (!startDate || due >= startDate) && (!endDate || due <= endDate);
    });
